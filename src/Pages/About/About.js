                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-5 md:mx-20 lg:mx-44'>
                            ...
                            <a href={resume} download>
                                ...
                                <button id='text' >
                                    <div className='flex items-center'>
                                        <p className='mx-5 text-black hover:text-white'>DOWNLOAD RESUME</p>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-5 my-5 mx-3 md:mx-0'>
                        <div className='border border-cyan-900 rounded-xl p-10shadow-2xl'>
                            <h1 className='text-2xl font-bold flex items-center justify-center text-cyan-700'>70 +</h1>
                        ...
                        <div className='border border-cyan-900 rounded-xl p-10  shadow-2xl'>
                            <h1 className='text-2xl font-bold text-center text-cyan-700'>Honors</h1>
                            <div className='flex items-center justify-center'>
                                <p>___</p>
                        ...
                        <div className='border border-cyan-900 rounded-xl p-10  shadow-2xl'>
                            <h1 className='text-2xl font-bold text-center text-cyan-700'>HSC</h1>
                            <div className='flex items-center justify-center'>
                                <p>___</p>
